...
<template>
	<Form @submit="submitContact" :validation-schema="contactFormSchema">
		...
		<div class="form-group">
			...
			<Field name="address" type="text" class="form-control" v-model="editedContact.address" />
			<ErrorMessage name="address" class="error-feedback" />
		</div>
		<div class="form-group">
			<label for="phone">Điện thoại</label>
			<Field name="phone" type="tel" class="form-control" v-model="editedContact.phone" />
			<ErrorMessage name="phone" class="error-feedback" />
		</div>
		<div class="form-group form-check">
			<Field name="favorite" type="checkbox" class="form-check-input" v-model="editedContact.favorite" :value="1" :unchecked-value="0" />
		...
		<div class="form-group">
			...
			<button v-if="editedContact.id" type="button" class="ml-2 btn btn-danger" @click="deleteContact">
				Xóa
			</button>
		</div>
	</Form>
